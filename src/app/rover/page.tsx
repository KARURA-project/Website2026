  ...
  const rovers = [
    {
      ...
      specs: [
        ...
        { label: 'Top Speed', value: '0.5 m/s' },
        { label: 'Battery Life', value: '4 hours' },
        { label: 'Arm Reach', value: '1.2 meters' },
      ],
      features: [
    ...
    },
    {
      ...
      specs: [
        ...
        { label: 'Top Speed', value: '0.4 m/s' },
        { label: 'Battery Life', value: '3.5 hours' },
        { label: 'Arm Reach', value: '1.0 meters' },
      ],
      features: [
        'GPS Navigation',
        'Object Detection',
    ...
    },
    {
      ...
      specs: [
        ...
        { label: 'Top Speed', value: '0.3 m/s' },
        { label: 'Battery Life', value: '3 hours' },
        { label: 'Arm Reach', value: '0.8 meters' },
      ],
      features: [
        'Manual Control',
        'Basic Sensors',
      ...
      <section className="py-32 bg-gray-50">
        <div className="max-w-[1400px] mx-auto px-8 md:px-12 lg:px-16 xl:px-20">
          ...
          <motion.div
            ...
            className="grid lg:grid-cols-2 gap-20 items-start max-w-6xl mx-auto"
          >
            {/* Image */}
